...
public class ClassroomController {
  ...
  @GetMapping
  public String listAllStudents(Model model) throws SQLException {
  ...
  @PostMapping("/add")
  public String addStudent(@Valid Student student, BindingResult bindingResult, RedirectAttributes attr) throws SQLException {
  ...
  @PostMapping("/delete")
  public String deleteStudent(int idx) throws SQLException {
  ...
  @PostMapping("/edit")
  public String editStudent(@Valid Student student,BindingResult bindingResult, RedirectAttributes attr) throws SQLException {
    if (bindingResult.hasErrors()) {
      attr.addFlashAttribute("org.springframework.validation.BindingResult.student", bindingResult);
      attr.addFlashAttribute("student", student);
